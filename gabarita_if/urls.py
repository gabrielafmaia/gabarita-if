...
urlpatterns = [
    ...
    path("ajax/questoes/<int:questao_id>/caderno/", ajax_adicionar_questao_caderno, name="ajax-adicionar-questao-caderno"),
    path("ajax/questoes/<int:questao_id>/caderno/criar/", ajax_criar_caderno_para_questao, name="ajax-criar-caderno-para-questao"),
    path("ajax/cadernos/bloco/", ajax_adicionar_bloco, name="ajax-adicionar-bloco"),
